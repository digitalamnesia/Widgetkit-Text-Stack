    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
				...
				<!-- SECOND CONTENT WIDTH -->
				<div class="uk-form-row">
                    <label class="uk-form-label" for="wk-width">{{'Second Content Width' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-width" class="uk-form-width-medium" ng-model="widget.data['text_width']">
                            <option value="1-5">20%</option>
                            <option value="1-4">25%</option>
                            <option value="3-10">30%</option>
                            <option value="1-3">33%</option>
				...
				<!-- SECOND CONTENT ALIGNMENT -->
				<div class="uk-form-row">
                    <label class="uk-form-label" for="wk-align">{{'Second Content Alignment' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-align" class="uk-form-width-medium" ng-model="widget.data['second_align']">
                            <option value="left">{{'Left' | trans}}</option>
                            <option value="right">{{'Right' | trans}}</option>
                        </select>
                    </div>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                       <select id="wk-text-align" class="uk-form-width-medium" ng-model="widget.data['text_align']">
							...
							<option value="media">{{'Justify' | trans}}</option>
                       </select>
                    </div>
                </div>
