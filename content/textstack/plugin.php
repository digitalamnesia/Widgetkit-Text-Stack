...
return array(
    ...
    'events' => array(
        ...
        'init.admin' => function($event, $app) {
            ...
            $app['scripts']->add('widgetkit-custom-controller', 'plugins/content/textstack/assets/controller.js');
            $app['angular']->addTemplate('textstack.edit', 'plugins/content/textstack/views/edit.php', true);
        }
